...
pub struct CourseOffering {
    // ── Core ───────────────────────────────────────────────────
    pub code: String,           // OP_CODE (section/opening code)
    pub course_code: String,    // CURS_CODE (catalog course code)
    pub assignment_key: String, // IDCODE or deterministic raw-row fallback
    ...
    pub classroom: String,       // CLS_NAME_1/2/3, joined for display/filtering
